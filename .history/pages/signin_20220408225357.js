    ...
    <div className="h-screen font-inter ">
      <div className="signin-container flex  ">
        ...
        <div className="signin-form bg-white w-full h-screen px-5 py-14">
          ...
          <form>
            <div className="email py-12 w-full">
              <input
                type={"email"}
            ...
            <div className="py-3">
              <p className="text-primary text-xl font-semibold">Forgotten Password ?</p>
            </div>

            <div className="button">
              <button className="p-4 rounded-xl w-full bg-primary text-center text-white font-black">
                Create Account
              </button>
            </div>
          </form>
