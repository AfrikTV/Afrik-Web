  ...
  return (
    <div className="h-screen font-inter ">
      <div className="signin-container flex  ">
        ...
        <div className="signin-form bg-white w-full h-screen px-8 py-14">
          ...
          <form className="py-12">
            ...
            <div className="button flex mx-auto py-5 w-96">
              <button type="submit" className="p-5 rounded-xl w-full bg-primary text-center text-white font-black">
                Create Account
              </button>
            </div>
          </form>
