...
function whoiswatching(props) {
  ...
  return (
    <div className="text-center py-28 bg-white h-screen px-10">
      <h1 className="font-black text-[25px] py-5  lg:text-[30px]">
        Who is Watching ?
      </h1>
      <div className=" mx-auto flex justify-center items-center">
        <div className="availableprofile cursor-pointer grid  gap-8 grid-col lg:grid-cols-3 py-10 items-center mx-auto justify-center">
