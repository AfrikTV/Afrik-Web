  ...
  return (
    <div className="h-screen ">
      <div className="signin-container flex  ">
        <div className="background-image w-full lg:flex items-center h-screen p-5 hidden lg:block bg-[#060825] text-white">
          <h1 className="text-5xl font-bold tracking-widest spa">Connect
            <br/>
            with Amazing <br/> Africa Movies</h1>
        </div>
