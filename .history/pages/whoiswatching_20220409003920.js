...
function whoiswatching(props) {
  ...
  return (
    <div className="text-center py-20 bg-white h-screen px-10">
      <h1 className="font-black text-[25px]  lg:text-[30px]">
        Who is Watching ?
      </h1>

      <div className="availableprofile grid grid-cols-2 gap-10 lg:grid-cols-3 justify-center py-10 items-center">
