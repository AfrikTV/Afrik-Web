      ...
      <div className="forgetpassword-container flex  ">
        ...
        <div className="signin-form bg-white w-full h-screen px-10 py-14">
          ...
          <form className="py-12">
            <div className="otp-container py-5 w-full flex flex-col lg:flex-row justify-center space-x-7">
              <div className="otp">
                <input
                  type={"text"}
                  maxLength={1}
                  className="h-[63px] w-[67px] border-[#E3E0E0] text-center rounded-lg text-3xl font-bold  bg-[#FAFAFA] outline-none"
                />
              </div>
