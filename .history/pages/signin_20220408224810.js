        ...
        <div className="signin-form bg-white w-full h-screen px-5 py-14">
          ...
          <form>
            <div className="email py-20 w-full">
              <input
                type={"email"}
                className="p-4 w-full bg-[#FAFAFA] border rounded outline-none border-[#E3E0E0]"
                placeholder="Email "
              />
            </div>

            <div className="button">
              <button className="bg-primary text-center text-white font-black">Create Account</button>
            </div>
          </form>
        </div>
      </div>
