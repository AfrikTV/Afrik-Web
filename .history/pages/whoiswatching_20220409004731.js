...
function whoiswatching(props) {
  ...
  return (
    <div className="text-center py-28 bg-white h-screen px-10">
      ...
      <div className="w-96 mx-auto flex justify-center ite">
        <div className="availableprofile grid w-96 gap-8 grid-cols-3 py-10 items-center mx-auto justify-center">
