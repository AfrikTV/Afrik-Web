...
const Hero2 = () => {
  return (
    <section className="py-20 px-10 ">
      ...
      <div className="discover  grid grid-cols-1  lg:grid-cols-3 lg:gap-32 items-center">
      ...
      <div className="your-favourite-movies my-16">
        ...
        <div className="discover my-10  grid grid-cols-1  lg:grid-cols-3 gap-1 lg:gap-32 items-center">
          <div className="discover-text col-span-2">
            <h2 className="text-5xl font-black  text-primary ">
              Discover the Best Entertainment
            </h2>
