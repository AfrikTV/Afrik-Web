    ...
    <section className="py-20 px-10 ">
      ...
      <div className="discover  grid grid-cols-1  lg:grid-cols-3 gap-32 items-center">
        <div className="discover-text col-span-2">
          <h2 className="text-5xl font-black  text-primary mt-10">
      ...
      <div className="your-favourite-movies text-center text-primary font-black text-xl">
        <h1>Your Favourite Afrik Movies</h1>
      </div>
    </section>
  );
};
