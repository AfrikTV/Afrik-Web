    ...
    <section className="py-20 px-10 ">
      ...
      <div className="your-favourite-movies my-16">
        ...
        <div className="discover my-10  grid grid-cols-1  lg:grid-cols-3 gap-1 lg:gap-32 items-center py-10">
          ...
          <div className="discover-image mx-auto grid grid-cols-2 items-center gap-5">
            <div className="photo-grid">
              <Image src={PhotoGridOne} alt="hero-image"  />
            </div>
            <div className="photo-grid">
              <Image src={PhotoGridTwo} alt="hero-image" layout="responsive" />
            </div>
            <div className="photo-grid">
              <Image
                src={PhotoGridThree}
            ...
            <div className="photo-grid">
              <Image src={PhotoGridOne} alt="hero-image" layout="responsive" />
            </div>
          </div>
        </div>
      </div>
