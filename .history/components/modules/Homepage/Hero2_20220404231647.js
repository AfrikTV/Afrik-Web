  ...
  return (
    <section className="py-20 px-10 ">
      ...
      <div className="amapiano">
        <div className="discover gri grid-row-start: auto  grid grid-cols-1  lg:grid-cols-3 gap-1 lg:gap-32 items-center">
          <div className="discover-text col-span-2">
            <h2 className="text-5xl font-black  text-primary ">
          ...
          <div className="discover-image mx-auto grid-column-start">
