...
const Footer = () => {
  return (
    <footer>
      <div className="subscribe-newsletter bg-[#060825] items-center justify-center py-10 px-10 font-inter text-center ">
        <h1 className="text-white font-bold text-4xl ">
          Subscribe to our newsletter
        </h1>

        <div className="input-container flex space-x-5 py-10   w-full">
