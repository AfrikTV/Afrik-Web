...
function ActionAfricaMovies() {
    return (

        <div className='font-[Poppins] flex flex-row flex-wrap gap-1 sm:gap-5'>
            <div className='flex flex-col cursor-pointer'>
                <Image className='rounded-md mv-img' src={local1} alt="movies" width={220} height={340} />
                <h1 className='text-white mt-3'>Black Panter</h1>
            </div>
            <div className='flex flex-col'>
                <Image src={local2} alt="movies" className='rounded-md' width={220} height={340} />
                <h1 className='text-white mt-3'>Black Panter</h1>
            </div>
            <div className='flex flex-col'>
                <Image src={local1} className='rounded-md' alt="movies" width={220} height={340} />
                <h1 className='text-white mt-3'>Black Panter</h1>
            </div>
            <div className='flex flex-col'>
                <Image src={local2} alt="movies" className='rounded-md' width={220} height={340} />
