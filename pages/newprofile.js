    ...
    <div className='flex flex-col items-center justify-center h-[100vh] w-[100vw]'>
      ...
      <div className="">
        ...
        <div className='flex mb-5 items-center gap-10 flex-row'>
          ...
          <input type="text" placeholder="Name" className="border-[#E3E0E0] bg-[#FAFAFA] placeholder:text-[#757984] w-[100%] border-[1px] font-medium p-3 rounded-lg" />
        </div>
        ...
        <div className="w-[100%] justify-center gap-10 items-center flex flex-row">
          ...
          <div onClick={() => router.back()}>
            <h1 className="text-[#060825] border-[1px] border-[#060825] w-[150px] text-center px-5 cursor-pointer py-3 font-medium rounded-lg mt-5 bg-white hover:shadow-lg">
              Cancel
            </h1>
          </div>
        </div>
